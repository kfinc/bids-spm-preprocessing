...
matlabbatch{2}.spm.spatial.preproc.tissue(1).tpm = {'/home/finc/Dropbox/MATLAB/spm12/tpm/TPM.nii,1'};
...
matlabbatch{2}.spm.spatial.preproc.tissue(2).tpm = {'/home/finc/Dropbox/MATLAB/spm12/tpm/TPM.nii,2'};
...
matlabbatch{2}.spm.spatial.preproc.tissue(3).tpm = {'/home/finc/Dropbox/MATLAB/spm12/tpm/TPM.nii,3'};
matlabbatch{2}.spm.spatial.preproc.tissue(3).ngaus = 2;
matlabbatch{2}.spm.spatial.preproc.tissue(3).native = [1 0];
matlabbatch{2}.spm.spatial.preproc.tissue(3).warped = [0 0];
matlabbatch{2}.spm.spatial.preproc.tissue(4).tpm = {'/home/finc/Dropbox/MATLAB/spm12/tpm/TPM.nii,4'};
matlabbatch{2}.spm.spatial.preproc.tissue(4).ngaus = 3;
matlabbatch{2}.spm.spatial.preproc.tissue(4).native = [1 0];
matlabbatch{2}.spm.spatial.preproc.tissue(4).warped = [0 0];
matlabbatch{2}.spm.spatial.preproc.tissue(5).tpm = {'/home/finc/Dropbox/MATLAB/spm12/tpm/TPM.nii,5'};
matlabbatch{2}.spm.spatial.preproc.tissue(5).ngaus = 4;
matlabbatch{2}.spm.spatial.preproc.tissue(5).native = [1 0];
matlabbatch{2}.spm.spatial.preproc.tissue(5).warped = [0 0];
matlabbatch{2}.spm.spatial.preproc.tissue(6).tpm = {'/home/finc/Dropbox/MATLAB/spm12/tpm/TPM.nii,6'};
...
matlabbatch{3}.spm.spatial.normalise.write.subj.resample(1) = cfg_dep('File Selector (Batch Mode): Selected Files (T1)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
